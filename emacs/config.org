...
(defun gk/show-cotton-log ()
  ...
  (let* ((directory "/mnt/c/Users/Oskar Sigvardsson/Desktop/Cotton Juce 5 Logs/")
		 ...
		 (path (concat directory latest-file)))
	(when (> (length latest-file) 5)
	  (find-file path)
	  (read-only-mode t)
	  (end-of-buffer t))
  ...
  (use-package telephone-line
    ...
    (setq telephone-line-primary-left-separator 'telephone-line-identity-right
          ...
          telephone-line-height 50)
                                          ...
                                          ; (add-to-list 'telephone-line-lhs '(nil . (telephone-line-is-modified-segment)))

    (setq telephone-line-lhs
          (cons (car telephone-line-lhs)
                (cons '(modified . (telephone-line-is-modified-segment))
                      (cdr telephone-line-lhs))))
