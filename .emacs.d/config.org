...
#+BEGIN_SRC emacs-lisp
  (setq-default mac-command-key-is-meta nil)
...
** GUI
No toolbar or scrollbar or frame border. Maybe no fringe?
...
#+BEGIN_SRC emacs-lisp
  (setq
   ...
   org-default-index-file  "~/Nextcloud/nas/Org/index.org"
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun default-window-setup ()
	...
	(progn
	  ...
	  (find-file org-default-index-file)
	  (other-window 1 nil)
